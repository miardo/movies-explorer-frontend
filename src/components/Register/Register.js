...
function Register(props) {
    ...
    return (
        <section className="register">
            ...
            <form className="register__edit-form" onSubmit={handleRegister} noValidate>
            ...
            <article className="register__edit-form-box">
                ...
                <input className="register__edit-form-input" type="email" name="email" placeholder="Email" value={values.email || ''} required onChange={handleChange}/>
                <span className="register__input-error" id="email-error">{errors.email}</span>
            </article>
            <article className="register__edit-form-box">
                <p className="register__edit-form-name">Пароль</p>
                <input className={`register__edit-form-input ${!errors.password ? '' : 'register__edit-form-input_error-style'}`} type="password" name="password" placeholder="" required value={values.password || ''} onChange={handleChange}/>
